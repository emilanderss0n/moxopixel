                        ...
                        <nav class="nav-menu" role="navigation" aria-label="Main menu">
                            <div class="nav-menu-inner">
                                <div class="nav-item animate-in animate-d2">
                                    <a href="#" class="nav-link home-trigger hover-effect hover-effect-cursor-square">
                                        <span>Home</span>
                                    </a>
                                </div>
                                <div class="nav-item animate-in animate-d3">
                                    <a href="#" class="nav-link about-trigger hover-effect hover-effect-cursor-square">
                                        <span>About Me</span>
                                    </a>
                                </div>
                                <div class="nav-item animate-in animate-d4">
                                    <a href="#" class="nav-link image-gallery-trigger hover-effect hover-effect-cursor-square">
                                        <span>Gallery</span>
                                    </a>
                                </div>
                            </div>
